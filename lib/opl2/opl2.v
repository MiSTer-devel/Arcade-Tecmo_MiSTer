...
module opl2 #(
  ...
  always @(posedge clk) begin
    channel_a_acc_pre_clamp_p[0] <= channel_2_op[0];
    channel_a_acc_pre_clamp_p[1] <= channel_2_op[1];
    channel_a_acc_pre_clamp_p[2] <= channel_2_op[2];
    channel_a_acc_pre_clamp_p[3] <= channel_2_op[3];
    channel_a_acc_pre_clamp_p[4] <= channel_2_op[4];
    channel_a_acc_pre_clamp_p[5] <= channel_2_op[5];
    channel_a_acc_pre_clamp_p[6] <= channel_2_op[6];
    channel_a_acc_pre_clamp_p[7] <= channel_2_op[7];
    channel_a_acc_pre_clamp_p[8] <= channel_2_op[8];
  end
  ...
  always @(posedge clk)
    if (sample_clk_en)
      if (channel_a_acc_pre_clamp > 2**15 - 1)
        ...
        sample <= channel_a_acc_pre_clamp;
  ...
  assign dout = ~a0 ? io_readdata : 8'hFF;
